	...
	public function boot(Router $router)
	{
        ...
        $router->group($config, function($router)
        {
            ...
            $router->any('connector', [
              ...
              'uses' => 'ElfinderController@showConnector'
            ]);
            $router->get('popup/{input_id}', [
              'as' => 'elfinder.popup',
              'uses' => 'ElfinderController@showPopup'
            ]);
            $router->get('filepicker/{input_id}', [
              'as' => 'elfinder.filepicker',
              'uses' => 'ElfinderController@showFilePicker'
            ]);
            $router->get('tinymce', [
              'as' => 'elfinder.tinymce',
            ...
            $router->get('tinymce5', [
              ...
              'uses' => 'ElfinderController@showTinyMCE5'
            ]);
            $router->get('ckeditor', [
