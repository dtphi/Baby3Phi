...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://ogp.me/ns/fb#">
    <head prefix=" og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
        ...
        <title>Babi3Phi | {{$data->settings['meta_title']}}</title>
    ...
    <body class="antialiased">
        ...
        <div id="babi-3-phi-front" class="relative items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
