          ...
          <ul class="nav nav-tabs">
            ...
            <li>
              <a href="#tab-data" data-toggle="tab">{{
                  $options.setting.tab_data_title
              }}</a>
            </li>
            <li>
              <a href="#tab-design" data-toggle="tab">{{
                  $options.setting.tab_design_title
              }}</a>
            </li>
          </ul>
            ...
            <div class="tab-pane active" id="tab-general">
              <div class="tab-content">
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-category-name">Tên</label>
                  <div class="col-sm-10">
                    <validation-provider name="category_name" rules="required|max:191" v-slot="{ errors }">
                      <input type="text" v-model="newsGroupAdd.name" placeholder="Tên nhóm tin" id="input-category-name"
                        class="form-control" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <b3p-tinymce id="input-category-description" name="category_description" :other_options="options"
                      v-model="newsGroupAdd.description" />
                  </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-meta-title">Meta title</label>
                  <div class="col-sm-10">
                    <validation-provider name="meta_title" rules="required|max:191" v-slot="{ errors }">
                      <input type="text" v-model="newsGroupAdd.meta_title" placeholder="Meta title"
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <validation-provider name="meta_description" rules="max:191" v-slot="{ errors }">
                      <textarea id="input-meta-description" v-model="newsGroupAdd.meta_description" class="form-control"
                        :placeholder="
                          $options.setting
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <validation-provider name="meta_keyword" rules="max:191" v-slot="{ errors }">
                      <textarea id="input-meta-keyword" v-model="newsGroupAdd.meta_keyword" class="form-control"
                        :placeholder="
                          $options.setting.tab_general_key_word_txt
                        "></textarea>
                      <span class="cms-text-red">{{ errors[0] }}</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <validation-provider name="tag" rules="max:191" v-slot="{ errors }">
                      <input id="input-tag" v-model="newsGroupAdd.tag" class="form-control" :placeholder="
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <validation-provider name="sort_order" rules="numeric|max:191" v-slot="{ errors }">
                    <input type="text" v-model="newsGroupAdd.sort_order" name="sort_order" placeholder="Thứ tự hiển thị"
                      id="input-category-sort-order" class="form-control" />
                    <span class="cms-text-red">{{ errors[0] }}</span>
                  </validation-provider>
                </div>
              </div>
...
import { MODULE_NEWS_CATEGORY_ADD, } from 'store@admin/types/module-types'
import {
  ACTION_SET_LOADING,
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(MODULE_NEWS_CATEGORY_ADD, ['newsGroupAdd', 'insertSuccess']),
    _errors() {
  ...
  methods: {
    ...
    async _submitInfo() {
      await this.$refs.observerNewsGroup.validate().then(isValid => {
        if (isValid) {
          this[ACTION_INSERT_NEWS_GROUP](this.newsGroupAdd)
        }
      })
    },
    async _submitInfoBack() {
      await this.$refs.observerNewsGroup.validate().then(isValid => {
        if (isValid) {
          this[ACTION_INSERT_NEWS_GROUP_BACK](this.newsGroupAdd)
        }
      })
    },
