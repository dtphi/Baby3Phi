<template>
  <b3p-button @click="_refreshList" custom-color="info" original-title="Tải lại danh sách">
...
export default {
  ...
  methods: {
    ...mapActions(MODULE_MODULE_RESTRICT_IP, [ACTION_GET_INFO_LIST]),
    _refreshList() {
      const params = {
