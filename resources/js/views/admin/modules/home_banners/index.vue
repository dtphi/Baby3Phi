        ...
        <div class="container-fluid">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><b3p-emoji emoji="list" />Thay đổi</h3>
            </div>
                  ...
                  <div class="tab-pane active" id="tab-general">
                    <div class="tab-content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/on-goi-linh-muc-241"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_loi_chua')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/loi-chua-210"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_audio_podcast')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_linh_muc')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/giam-muc-18"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_giao_xu')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/giao-phan-207"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_thong_bao')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/thong-bao-209"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                          <span
                            class="btn btn-default"
                            @click="_selectImage('img_phung_vu')"
                          >
                            <i class="fa fa-image fa-fw" />
                          </span>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input
                            placeholder="/danh-muc-tin/phung-vu-213"
...
import { MODULE_MODULE_HOME_BANNER, } from 'store@admin/types/module-types'
import {
  ACTION_SET_IMAGE,
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(MODULE_MODULE_HOME_BANNER, ['banners', 'updateSuccess']),
    _getOnGoiAvatar() {
  ...
  methods: {
    ...
    _submitInfo() {
      this.$refs.observerNewsGroup.validate().then(isValid => {
        if (isValid) {
          this.moduleUpdateBanner()
        }
      })
    },
    _selectImage(type) {
