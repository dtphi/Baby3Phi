...
const appMiddle = process.env.APP_API_NAME_KEY
const firebasephoneMiddle = process.env.APP_API_FIREBASE_PHONE_NAME_KEY
let apiBaseUrl = `${baseUrl}/api/product`
if (process.env.APP_ENV !== 'production') {
  baseUrl = 'http://localhost:8000'
  apiBaseUrl = `${baseUrl}/api/product`
}
...
export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'icon', type: 'image/x-icon', href: '/images/icons/favicon.png' },
      {
        ...
        type: 'image/x-icon',
        href: '/images/icons/favicon-144x144.png',
      },
      {
        rel: 'apple-touch-icon-precomposed',
        type: 'image/x-icon',
      ...
      },
      {
        rel: 'apple-touch-icon-precomposed',
        type: 'image/x-icon',
        href: '/images/icons/favicon-57x57.png',
      },
    ],
  },
  ...
  plugins: ['@/plugins/local-storage.js'],
  ...
  build: {
    publicPath: '/js/views/statics/product-js',
  },
